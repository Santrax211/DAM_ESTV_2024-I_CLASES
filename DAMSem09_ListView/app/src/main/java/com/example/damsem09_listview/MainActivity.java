...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        estudiantes.add("Mondragon Parodi, Alberto Ismael");
        estudiantes.add("Urbisagastegui Huamani, Jhon Antony");
        estudiantes.add("Pascacio Sanchez, Roxana Gadita");
        estudiantes.add("Capcha Martinez, Jorge Samir");
        estudiantes.add("Ayquipa Estrada, Jheremy William");
        estudiantes.add("...");
